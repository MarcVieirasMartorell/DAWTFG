...
INSERT INTO hero_scripts VALUES
  ('click',     'CURSOR.EXE', 'click()',          4,  26, 40,   0,   0, 'single', NULL,        'Sharp double-click on one target.'),
  ...
  ('patch',     'GUARD.SYS',  'patch.dll(ally)',  10,  0,  0,  55,  82, 'heal',   NULL,        'Restore an ally''s INTEGRITY.'),
  ...
  ('kill9',     'PURGE.BAT',  'kill -9 (target)', 14, 42, 66,   0,   0, 'single', NULL,        'Force-terminate a process.'),
  ...
  ('whoami',    'ROOT.SH',    'sudo whoami',      3,  24, 38,   0,   0, 'single', NULL,        'Identify-and-strike combo.'),
  ('grep',      'ROOT.SH',    'sudo grep(t)',     6,   0,  0,   0,   0, 'debuff', 'expose',    'Find exploit — next hit crits.'),
  ('restart',   'ROOT.SH',    'sudo restart(a)',  19,  0,  0,  95, 130, 'heal',   NULL,        'Revive a faulted ally with high HP.'),
...
INSERT INTO enemies VALUES
  ('POPUP.IMP',     '001', 'NUISANCE', 'POPUP MOOR',    'A loose dialog window with teeth. Annoying but fragile.',              72,  1.40, 12, 20,  8),
  ('TRACKER.SLIME', '002', 'COOKIE',   'COOKIE WOODS',  'A semi-sentient tracking cookie. Splits when stomped.',                95,  1.00, 14, 20, 10),
  ('CACHE.GHOUL',   '003', 'SPECTER',  'TEMP CAVES',    'Fossilized cache entry that refuses to expire.',                      115,  0.90, 16, 24, 14),
  ('PHISH.WYRM',    '004', 'LURE',     'PROXY PASS',    'Disguises itself as a legitimate form. Hits all targets on detect.',  175,  0.85, 22, 34, 20),
  ('KEYLOG.RAT',    '005', 'SPY',      'MINIBOSS',      'Watches keystrokes. Attacks when you least expect it.',               210,  1.30, 20, 32, 35),
  ('RANSOM.LARVA',  '006', 'CRYPTO',   'SECTOR FALLS',  'Encrypts processes one by one. Has a healing phase.',                 130,  1.00, 16, 26, 18),
  ('TROJAN.WORM',   '007', 'BOSS',     'CORE CHAMBER',  'The root threat. Corrupts sectors and spawns minions.',               380,  0.60, 18, 30, 120);
...
INSERT INTO game_settings VALUES ('sprite_overrides','{\"heroes\":{\"CURSOR.EXE\":{\"grid\":[\"..aa............\",\"..aka...........\",\"..akka..........\",\"..akkka.........\",\"..akkkka........\",\"..akkkkka.......\",\"..akkkakka......\",\"..akkkkkkka.....\",\"..akakkakkka....\",\"..akkkaakka.....\",\"..akkkkkka......\",\"..akkkaakka.....\",\"..akka..akaa....\",\"...aa....a..a...\",\".......aaa..aa..\",\"......a......a..\",\"......a......a..\",\"....aaa.....aa..\"],\"body\":\"#2a3a55\",\"rim\":\"#a5b985\",\"dark\":\"#020806\",\"acc\":\"#fefae0\",\"eye\":\"#fefae0\",\"role\":\"POINTER\",\"bio\":\"Legacy input device. Precise single-target striker; cheap on CPU.\",\"hpMax\":220,\"cpuMax\":60,\"spd\":1.3,\"atk\":[22,36],\"limitName\":\"CLICKSTORM\",\"limitDesc\":\"rage-click() — 6 random hits\",\"scripts\":[{\"id\":\"click\",\"label\":\"click()\",\"cost\":4,\"dmg\":[26,40],\"kind\":\"single\",\"desc\":\"Sharp double-click on one target.\"},{\"id\":\"drag\",\"label\":\"drag(target)\",\"cost\":8,\"dmg\":[18,30],\"kind\":\"single\",\"extra\":\"knockback\",\"desc\":\"Knock target back; -1 ATB.\"},{\"id\":\"selectall\",\"label\":\"select_all()\",\"cost\":18,\"dmg\":[14,24],\"kind\":\"aoe\",\"desc\":\"Hits every active threat.\"},{\"id\":\"inspect\",\"label\":\"inspect(elem)\",\"cost\":6,\"dmg\":[0,0],\"kind\":\"debuff\",\"extra\":\"expose\",\"desc\":\"Expose weakness — next hits crit.\"}]},\"GUARD.SYS\":{\"grid\":[\"......####......\",\".....######.....\",\"....#e#e#e##....\",\"k...#e#e#e##...k\",\"kkk.########.kkk\",\"kaakkkkkkkkkkaak\",\"kraaaaakaaaaaaak\",\"kraaaaakaaaaaakk\",\"krkaaaakaaakaaak\",\"kaaaaaakaakaaaak\",\"kaaaaaakaaaaaaak\",\"##aakaakaaaaaa##\",\"##aaaaakaaaaak##\",\"##kaaaakaakaak##\",\"...kaaakaaaak...\",\"....kaakaaak....\",\"....#kakaak#....\",\"...###kkkk###...\"],\"body\":\"#3a3a18\",\"rim\":\"#d4f4a3\",\"dark\":\"#020806\",\"acc\":\"#fefae0\",\"eye\":\"#fefae0\",\"role\":\"TANK\",\"bio\":\"System sentinel. High HP. Heals, shields and pulls aggro.\",\"hpMax\":410,\"cpuMax\":80,\"spd\":0.95,\"atk\":[16,26],\"limitName\":\"PORT 22 LOCKDOWN\",\"limitDesc\":\"firewall_all() — block next round\",\"scripts\":[{\"id\":\"patch\",\"label\":\"patch.dll(ally)\",\"cost\":10,\"heal\":[55,82],\"kind\":\"heal\",\"desc\":\"Restore an ally\'s INTEGRITY.\"},{\"id\":\"shield\",\"label\":\"shield_up(ally)\",\"cost\":10,\"kind\":\"buff\",\"extra\":\"shield\",\"desc\":\"Halve incoming damage on ally.\"},{\"id\":\"reroute\",\"label\":\"reroute(ally)\",\"cost\":6,\"kind\":\"buff\",\"extra\":\"taunt\",\"desc\":\"Pull all aggro to GUARD.SYS.\"},{\"id\":\"backup\",\"label\":\"backup.zip()\",\"cost\":24,\"heal\":[40,55],\"kind\":\"aoehel\",\"desc\":\"Heal the whole party.\"}]},\"PURGE.BAT\":{\"grid\":[\"................\",\"................\",\".........r......\",\"........rr......\",\".......r##r.....\",\".......r#er.....\",\"......r####r....\",\"......r#e##r....\",\".e...r#e####r...\",\"eee..r####e#r...\",\".e..rrrrrrrrrr..\",\".a....kekekk....\",\".a....######....\",\".aa####rrrr##...\",\"..arrrrrrrrr#...\",\"..a###rrrrrr#...\",\"..a..#r###rr#...\",\"..a.###...###...\"],\"body\":\"#1a0a2a\",\"rim\":\"#4d2376\",\"dark\":\"#000000\",\"acc\":\"#8a6438\",\"eye\":\"#ffd270\",\"role\":\"PURIFIER\",\"bio\":\"Antimalware shell. Heavy damage and brutal debuffs at high CPU cost.\",\"hpMax\":175,\"cpuMax\":100,\"spd\":1.1,\"atk\":[26,40],\"limitName\":\"rm -rf /malware/*\",\"limitDesc\":\"999 dmg AoE — purge all\",\"scripts\":[{\"id\":\"kill9\",\"label\":\"kill -9 (target)\",\"cost\":14,\"dmg\":[42,66],\"kind\":\"single\",\"desc\":\"Force-terminate a process.\"},{\"id\":\"chmod000\",\"label\":\"chmod 000(t)\",\"cost\":12,\"kind\":\"debuff\",\"extra\":\"silence\",\"desc\":\"Strip target\'s privileges (skip turn).\"},{\"id\":\"qrtn\",\"label\":\"quarantine(t)\",\"cost\":14,\"kind\":\"debuff\",\"extra\":\"freeze\",\"desc\":\"Encase target — no actions for 2 ticks.\"},{\"id\":\"sudormrf\",\"label\":\"sudo rm -rf .\",\"cost\":28,\"dmg\":[34,52],\"kind\":\"aoe\",\"desc\":\"Wipe-attempt AoE on all enemies.\"}]},\"PING.DLL\":{\"grid\":[\"................\",\"................\",\"................\",\"....####........\",\"...#rrr##.......\",\"...#reer#.......\",\"...#rerr#aaa....\",\"...#rrrkr#a.....\",\"...#rrkkrr#...a.\",\"...#rrrrkr##..aa\",\"....#rrkkrrr###.\",\"....#rrrrrrrr##.\",\".....#rrrrr###..\",\"......#####.....\",\"......#...#.....\",\"......a...a.....\",\"......a...a.....\",\".....aa..aa.....\"],\"body\":\"#1a3a55\",\"rim\":\"#88abdd\",\"dark\":\"#020816\",\"acc\":\"#2b41b1\",\"eye\":\"#ffdc4a\",\"role\":\"SCOUT\",\"bio\":\"Network probe. Hits fast, exposes weaknesses, scrambles enemy timing.\",\"hpMax\":160,\"cpuMax\":70,\"spd\":1.5,\"atk\":[18,28],\"limitName\":\"TRACEROUTE\",\"limitDesc\":\"reveal-all + multi-hit chain\",\"scripts\":[{\"id\":\"ping\",\"label\":\"ping(target)\",\"cost\":2,\"dmg\":[14,24],\"kind\":\"single\",\"desc\":\"Quick packet — fast & cheap.\"},{\"id\":\"tracert\",\"label\":\"tracert()\",\"cost\":10,\"dmg\":[10,18],\"kind\":\"aoe\",\"desc\":\"Hit every enemy + map their weak ports.\"},{\"id\":\"jitter\",\"label\":\"jitter(target)\",\"cost\":6,\"kind\":\"debuff\",\"extra\":\"freeze\",\"desc\":\"Scramble target\'s ATB (loses turn).\"},{\"id\":\"wget\",\"label\":\"wget(target)\",\"cost\":8,\"dmg\":[20,32],\"kind\":\"single\",\"desc\":\"Yank packet — chance to steal an item.\"}]},\"ROOT.SH\":{\"grid\":[\".......aa.......\",\".....r.aa.r.....\",\".....aaaaaa.....\",\".....######.....\",\"....##e##e##....\",\"....##e##e##....\",\"....#k####k#....\",\"....##kkkk##....\",\"..aa.######.aa..\",\".aa##########aa.\",\".aa##rr##rr##aa.\",\".aa##r####r##aa.\",\"..aa########aa..\",\"....##....##....\",\"....##....##....\",\"....rr....rr....\",\"....rr....rr....\",\"...rrr....rrr...\"],\"body\":\"#3a0a1a\",\"rim\":\"#ffdc4a\",\"dark\":\"#020806\",\"acc\":\"#ffdc4a\",\"eye\":\"#fefae0\",\"role\":\"ADMIN\",\"bio\":\"Privileged user. Versatile mix of damage, revive, and buffs.\",\"hpMax\":280,\"cpuMax\":90,\"spd\":1,\"atk\":[24,38],\"limitName\":\"sudo shutdown -h NOW\",\"limitDesc\":\"massive single-target nuke\",\"scripts\":[{\"id\":\"whoami\",\"label\":\"sudo whoami\",\"cost\":3,\"dmg\":[24,38],\"kind\":\"single\",\"desc\":\"Identify-and-strike combo.\"},{\"id\":\"grep\",\"label\":\"sudo grep(t)\",\"cost\":6,\"kind\":\"debuff\",\"extra\":\"expose\",\"desc\":\"Find target\'s exploit — next hit crits.\"},{\"id\":\"restart\",\"label\":\"sudo restart(a)\",\"cost\":19,\"heal\":[95,130],\"kind\":\"heal\",\"desc\":\"Revive a faulted ally with high HP.\"},{\"id\":\"nice\",\"label\":\"sudo nice -20\",\"cost\":10,\"kind\":\"buff\",\"extra\":\"haste\",\"desc\":\"Boost an ally\'s ATB rate.\"}]},\"INDEX.LOG\":{\"grid\":[\"................\",\"................\",\"................\",\".....rrrrrrr....\",\"....r######r....\",\"....ree#ee#r....\",\"....r#######r...\",\"....r#rrr##rr...\",\"....rr###rrr....\",\".....rrrraaar...\",\"......rrrrrar...\",\"......rkkkraar..\",\"......rkk##aar..\",\"......rkkkraar..\",\"......rrrrraaar.\",\".......raaaaaar.\",\".......raaaaaar.\",\".......rrrrrrrr.\"],\"body\":\"#3a2a18\",\"rim\":\"#ffffff\",\"dark\":\"#020806\",\"acc\":\"#7d2212\",\"eye\":\"#a5e58a\",\"role\":\"ARCHIVIST\",\"bio\":\"Keeper of logs. Specialist in debuffs and information warfare.\",\"hpMax\":200,\"cpuMax\":85,\"spd\":0.85,\"atk\":[20,30],\"limitName\":\"STACK TRACE\",\"limitDesc\":\"expose all — party hits crit\",\"scripts\":[{\"id\":\"logwrite\",\"label\":\"log.write()\",\"cost\":2,\"dmg\":[16,24],\"kind\":\"single\",\"desc\":\"Append a damaging entry to target.\"},{\"id\":\"audit\",\"label\":\"audit.fail(t)\",\"cost\":6,\"kind\":\"debuff\",\"extra\":\"expose\",\"desc\":\"Force target to admit weakness.\"},{\"id\":\"syslog\",\"label\":\"syslog.flood\",\"cost\":12,\"kind\":\"debuff\",\"extra\":\"silence\",\"desc\":\"Drown all foes in noise — silence AoE.\"},{\"id\":\"rotate\",\"label\":\"log.rotate(t)\",\"cost\":8,\"dmg\":[28,42],\"kind\":\"single\",\"desc\":\"Recursive overwrite — heavy hit.\"}]}},\"enemies\":{\"POPUP.IMP\":{\"grid\":[\"................\",\"................\",\"................\",\"................\",\"................\",\"...#........#...\",\"...##......##...\",\"....########....\",\"#...#kkkkkk#....\",\"##..#kekkke#....\",\"#...#keekee#....\",\"#...#kkkkkk#....\",\"############....\",\"....#......#....\",\"....#......#....\",\"...#.#....#.#...\",\"................\",\"................\"],\"body\":\"#c96969\",\"rim\":\"#fefae0\",\"dark\":\"#591818\",\"acc\":\"#d39b3c\",\"eye\":\"#d26c2d\",\"hp\":72,\"dmg\":[12,20],\"spd\":1.4,\"xp\":12,\"attacks\":[{\"id\":\"ax1sp\",\"name\":\"UNSKIPPABLE.AD()\",\"kind\":\"single\",\"dmg\":[12,20]}]},\"TRACKER.SLIME\":{\"grid\":[\"................\",\"................\",\"................\",\"....########....\",\"..###k####k###..\",\".########k####k.\",\".####r####r####.\",\".#k##rr##rr####.\",\".##############.\",\".###rrrrrrrr#k#.\",\".#k#r######r###.\",\"..####k##k####..\",\"...####k#####...\",\"....########....\",\".....kkkkkk.....\",\"................\",\"................\",\"................\"],\"body\":\"#b07840\",\"rim\":\"#fff1cf\",\"dark\":\"#3a200a\",\"acc\":\"#9a3a3a\",\"eye\":\"#1a0a00\",\"hp\":95,\"dmg\":[14,20],\"spd\":1,\"xp\":18,\"attacks\":[{\"id\":\"ax0od\",\"name\":\"FORCED.COOKIES()\",\"kind\":\"single\",\"dmg\":[14,20]}]},\"CACHE.GHOUL\":{\"grid\":[\"..#.............\",\".....######...#.\",\"....########..#.\",\"#..###e##e###...\",\"#..###e##e#.#...\",\"#..########.#...\",\"...##########...\",\"...#.#r##r###...\",\"...###rrrr###...\",\"...#.########...\",\"...#..####..#...\",\"...##.###..##...\",\"...##########...\",\"...#k#k#k#k#...\",\"...#.#.#.#.#...\",\"...#...#...#...\",\".#...#..........\",\".#.........#....\"],\"body\":\"#9bc4ff\",\"rim\":\"#e6f1ff\",\"dark\":\"#13294a\",\"acc\":\"#ff6ec7\",\"eye\":\"#3a1a4a\",\"hp\":115,\"dmg\":[16,24],\"spd\":0.9,\"xp\":22,\"attacks\":[{\"id\":\"axgjd\",\"name\":\"PHANTOM.PAIN()\",\"kind\":\"single\",\"dmg\":[16,24]},{\"id\":\"axl2i\",\"name\":\"LAG.BOMB()\",\"kind\":\"aoe\",\"dmg\":[8,14]}]},\"KEYLOG.RAT\":{\"grid\":[\"................\",\".aa......aa.....\",\"ae#a....a#ea....\",\"a#ea....ae#a....\",\"ae#a....a#ea....\",\".aa##aa##aa.....\",\"..########......\",\".####aa####aaaa.\",\".###aeaa###aaaa.\",\".###aeea#kk#####\",\".####aa####kkkk#\",\"..########...a.a\",\"...######.......\",\"...#....#.......\",\"...#....#.......\",\"..###..###......\",\"...#....#.......\",\"................\"],\"body\":\"#7a6a55\",\"rim\":\"#cfb38a\",\"dark\":\"#1a120a\",\"acc\":\"#fefae0\",\"eye\":\"#ff3a3a\",\"hp\":210,\"dmg\":[20,32],\"spd\":1.3,\"xp\":60,\"attacks\":[{\"id\":\"axuj2\",\"name\":\"KEY.STAB()\",\"kind\":\"single\",\"dmg\":[20,32]},{\"id\":\"axxju\",\"name\":\"STEAL.YOUR.PWORD()\",\"kind\":\"aoe\",\"dmg\":[12,18]},{\"id\":\"axbsl\",\"name\":\"CONSUME.KEY()\",\"kind\":\"heal\",\"heal\":[30,50]}]},\"PHISH.WYRM\":{\"grid\":[\".aaa............\",\"aaaa............\",\".aa.............\",\"..aa....####....\",\"..a#####rrrrr#..\",\"..#rrrrr####ee..\",\".#r#kkkkk#####..\",\"#r#k....k###rrr#\",\"##k......kkkrkkk\",\"#k..........r...\",\"##..............\",\"##..............\",\"#r#...........r.\",\"##r#.........rr.\",\"k##r#.......##..\",\".kk#r#.....##k..\",\"...k#r#####kk...\",\"....kkkkkkk.....\"],\"body\":\"#3a8a5b\",\"rim\":\"#a5e58a\",\"dark\":\"#0a2a18\",\"acc\":\"#d4a373\",\"eye\":\"#ffdc4a\",\"hp\":175,\"dmg\":[22,34],\"spd\":0.85,\"xp\":80,\"attacks\":[{\"id\":\"ax988\",\"name\":\"TAIL.WHIP()\",\"kind\":\"single\",\"dmg\":[22,34]},{\"id\":\"axxq8\",\"name\":\"TAIL.SWEEP()\",\"kind\":\"aoe\",\"dmg\":[10,18]},{\"id\":\"ax6le\",\"name\":\"SCALE.COAT()\",\"kind\":\"shield\"}]},\"RANSOM.LARVA\":{\"grid\":[\".....a....a.....\",\".....######.....\",\"....#a####a#....\",\"...##aa##aa##...\",\"...##########...\",\"...####aa####...\",\"...##########...\",\"...####aa####...\",\".aa###aaaa###aa.\",\"...##aaaaaa##...\",\".aa##a####a##aa.\",\"...##a#kk#a##...\",\"...##a####a##...\",\".aa##aaaaaa##aa.\",\"...k########k...\",\"....k######k....\",\".....kkkkkk.....\",\"................\"],\"body\":\"#7a4a8a\",\"rim\":\"#d4a3e5\",\"dark\":\"#1a0a2a\",\"acc\":\"#ffdc4a\",\"eye\":\"#1a0a00\",\"hp\":130,\"dmg\":[16,26],\"spd\":1,\"xp\":44,\"attacks\":[{\"id\":\"axd4o\",\"name\":\"SMOL.BITE()\",\"kind\":\"single\",\"dmg\":[16,26]},{\"id\":\"axcgh\",\"name\":\"HARDEN()\",\"kind\":\"shield\"},{\"id\":\"axdpt\",\"name\":\"HIVE.MIND()\",\"kind\":\"heal\",\"heal\":[30,50]}]},\"TROJAN.WORM\":{\"grid\":[\"aaaaa...rr..aaaa\",\"#a.......r....a#\",\"##aaaa...r.aaa##\",\"###aa...rr..a###\",\"#####a..r..a####\",\"###e##a.r.aa####\",\"rreerr#ara#rrrrr\",\"#eee####a#######\",\"################\",\"kkkkkkkkkkkkkkkk\",\"######rrrrrr####\",\"################\",\"################\",\"rrrrrrrrrrrrrrrr\",\"################\",\"################\",\"kkkkkkkkkkkkkkkk\",\"################\"],\"body\":\"#563c20\",\"rim\":\"#d4a373\",\"dark\":\"#1a0a00\",\"acc\":\"#9a1a1a\",\"eye\":\"#ffdc4a\",\"hp\":380,\"dmg\":[18,30],\"spd\":0.60,\"xp\":400,\"attacks\":[{\"id\":\"axd0p\",\"name\":\"ENGULF()\",\"kind\":\"aoe\",\"dmg\":[10,18]},{\"id\":\"ax8lx\",\"name\":\"HARDEN.V2()\",\"kind\":\"buff\"},{\"id\":\"axy9k\",\"name\":\"CHOMP()\",\"kind\":\"single\",\"dmg\":[18,28]}]}}}',NOW());
